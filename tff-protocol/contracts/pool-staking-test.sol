...
contract TffRetirementFundTest is ReentrancyGuard, Pausable {
    ...
    uint256 private minimumLock = 5 minutes;
    uint256 private maximumLock = 10 minutes;
        ...
        updateReward(msg.sender)
    {
        ...
        uint256 lockMultiplier = ((lockPeriod - minimumLock).div(1 minutes)).mul(10).add(multiplierBase);
